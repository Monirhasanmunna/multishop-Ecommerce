...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h1 class="h4 mb-0 text-primary"><i class="fa-solid px-1 fa-circle-check"></i>Unit</h1>
        <ol class="breadcrumb">
                                    ...
                                    <tbody>
                                      @foreach ($units as $key=>$unit)
                                        <tr role="row" class="odd text-center">
                                            ...
                                            <td>
                                                <a class="btn-sm btn-primary" href="{{Route('app.unit.edit',$unit->id)}}"><i class="fa fa-pen-to-square"></i></a>
                                                <a class="btn-sm btn-danger" href="javaScript::void(0)" onclick="deleteUser({{$unit->id}})"><i class="fa-solid fa-trash"></i></a> 
                                            </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
