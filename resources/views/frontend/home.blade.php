                    ...
                    <a class="text-decoration-none" href="">
                        <div class="cat-item d-flex align-items-center mb-4">
                            <div class="overflow-hidden" style="width: 100px; height: 100px;">
                                <img style="height: 100%" class="img-fluid" src="{{asset($category->image)}}" alt="{{$category->image}}">
                            </div>
                ...
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        @foreach ($product->images as $productImages)
                            @if ($loop->first)
                                <img style="height:300px" class="img-fluid w-100 p-3" src="{{asset($productImages->image)}}" alt="{{$productImages->image}}">  
                            @endif
                        @endforeach
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                    ...
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>${{isset($product->offer_price) ? $product->offer_price : $product->price}}</h5><h6 class="text-muted ml-2"><del>{{isset($product->offer_price) ? '$'. $product->price : '' }}</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <small class="fa fa-star text-primary mr-1"></small>
                            <small class="fa fa-star text-primary mr-1"></small>
